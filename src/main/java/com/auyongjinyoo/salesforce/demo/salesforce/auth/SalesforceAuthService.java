...
import com.auyongjinyoo.salesforce.demo.salesforce.config.SalesforceSecurityProperties;
...
public class SalesforceAuthService {
    ...
    public SalesforceSession login() {
        ...
        params.put("username", salesforceSecurityProperties.getUserName());
        params.put("password", salesforceSecurityProperties.getPassword());
